...
First of all, I want to thank everyone who made pull requests for NeoUptime. I never thought the GitHub Community would be so nice! Because of this, I also never thought that other people would actually read and edit my code. It is not very well structured or commented, sorry about that.
...
## Can I create a pull request for NeoUptime?
...
- Buggy
- UI/UX is not close to NeoUptime 
...
I will mark your pull request in the [milestones](https://github.com/tomtoe6600/uptime-kuma/milestones), if I am plan to review and merge it.
...
1. Create a pull request: https://github.com/tomtoe6600/uptime-kuma/compare
...
I personally do not like something that requires so many configurations before you can finally start the app. I hope NeoUptime installation could be as easy as like installing a mobile app.
...
NeoUptime Frontend is a single page application (SPA). Most paths are handled by Vue Router.
...
Please read: https://github.com/tomtoe6600/uptime-kuma/tree/master/src/languages

## Wiki

Since there is no way to make a pull request to wiki's repo, I have set up another repo to do that.

https://github.com/tomtoe6600/uptime-kuma-wiki

## Maintainer

Check the latest issues and pull requests:
https://github.com/tomtoe6600/uptime-kuma/issues?q=sort%3Aupdated-desc
...
- Check all tags is fine on https://hub.docker.com/r/tomtoe6600/uptime-kuma/tags
...
```bash
git clone https://github.com/tomtoe6600/uptime-kuma-wiki.git
cd uptime-kuma-wiki
git remote add production https://github.com/tomtoe6600/uptime-kuma.wiki.git
```
