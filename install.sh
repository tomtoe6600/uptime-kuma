...
# curl -o kuma_install.sh https://raw.githubusercontent.com/tomtoe6600/uptime-kuma/master/install.sh && sudo bash kuma_install.sh
"echo" "-e" "====================="
"echo" "-e" "NeoUptime Installer"
"echo" "-e" "====================="
"echo" "-e" "Supported OS: CentOS 7/8, Ubuntu >= 16.04 and Debian"
"echo" "-e" "---------------------------------------"
"echo" "-e" "This script is designed for Linux and basic usage."
"echo" "-e" "For advanced usage, please go to https://github.com/tomtoe6600/uptime-kuma/wiki/Installation"
"echo" "-e" "---------------------------------------"
"echo" "-e" ""
"echo" "-e" "Local - Install NeoUptime in your current machine with git, Node.js 14 and pm2"
"echo" "-e" "Docker - Install NeoUptime Docker container"
"echo" "-e" ""
if [ "$1" != "" ]; then
  type="$1"
else
...
if [ "$type" == "local" ]; then
  ...
  docker run -d --restart=always -p $port:3001 -v $volume:/app/data --name uptime-kuma tomtoe6600/uptime-kuma:1
fi
